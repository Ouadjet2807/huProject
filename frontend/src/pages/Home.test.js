...
describe("Home", () => {
  ...
  it("Should render an admin tag next to user firstname and lastname if user is admin", () => {
  ...
  it("Should not render admin tag next to user firstname and lastname if user is not admin", () => {
    render(<Home user={users[0]} loading={false} caregivers={caregivers} />, {
      wrapper: ProviderWrapper,
    });
