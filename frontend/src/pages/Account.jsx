  ...
  return (
    <div id="account">
      <div className="toolbar">
        <ul>
          <li className={activeTab === "profile" ? 'active' : ''} onClick={() => setActiveTab("profile")}>Votre profil</li>
          <li className={activeTab === "space" ? 'active' : ''} onClick={() => setActiveTab("space")}>Votre espace</li>
        </ul>
      </div>
            ...
            <div className="user-info">
              <div className="text">
                ...
                {editMode.active && editMode.target === "generalInfo" ? (
                  ...
                  <small><PiAtLight/>{user && user.username}</small>
                )}
                <span>{getAccess_level()}</span>
              </div>
